...
[PrimaryKey("PtId", "PtVisitId", "PtTrAsmtId")]
[Table("tr_asmt")]
[Index("PtId", "EffDate", "TrTyp", "TrCompName", Name = "nc1_tr_asmt")]
public partial class TrAsmt
{
    [Key]
    [Column("pt_id")]
    [StringLength(20)]
    ...
    [ForeignKey("TrAsmtTyp")]
    [InverseProperty("TrAsmt")]
    public virtual TrAsmtTyp TrAsmtTypNavigation { get; set; } = null!;

    [ForeignKey("GsAuthor, EffDate, TrTyp, TrCompName")]
    [InverseProperty("TrAsmt")]
    public virtual TrComp TrComp { get; set; } = null!;

    [ForeignKey("TrCsCertTyp")]
    [InverseProperty("TrAsmt")]
    public virtual TrCsCertTyp? TrCsCertTypNavigation { get; set; }

    [ForeignKey("TrCsTyp")]
    [InverseProperty("TrAsmt")]
    public virtual TrCsTyp? TrCsTypNavigation { get; set; }
}
