...
[PrimaryKey("PtId", "PtVisitId", "VisitNoteId", "DictationQueueId")]
[Table("visit_note_dictation")]
public partial class VisitNoteDictation
{
    [Key]
    [Column("pt_id")]
    [StringLength(20)]
    ...
    [InverseProperty("VisitNoteDictation")]
