...
[PrimaryKey("PtId", "AgtName", "DosageForm", "DateStarted")]
[Table("xref_agt_pt")]
public partial class XrefAgtPt
{
    [Key]
    [Column("pt_id")]
    [StringLength(20)]
    ...
    [ForeignKey("DateStartedCd")]
    [InverseProperty("XrefAgtPt")]
    public virtual DateCd? DateStartedCdNavigation { get; set; }
