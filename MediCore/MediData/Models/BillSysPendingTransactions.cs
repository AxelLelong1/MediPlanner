...
[PrimaryKey("VarisBillRunSeqId", "ActInstProcCodeSer", "ActInstProcCodeRevCount", "ChargeIndicator", "BillSysInstId", "BillSysId")]
public partial class BillSysPendingTransactions
{
    [Key]
    public long VarisBillRunSeqId { get; set; }
    ...
    [InverseProperty("BillSysPendingTransactions")]
