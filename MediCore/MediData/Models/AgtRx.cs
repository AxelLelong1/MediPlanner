...
[Table("agt_rx")]
[Index("AdmnStartDate", Name = "nc1_agt_rx")]
[Index("PlacerOrderNo", Name = "nc2_agt_rx")]
[Index("AppCd", Name = "nc3_agt_rx")]
[Index("RxTyp", "DispLocId", "AdmnStartDate", Name = "nc4_agt_rx")]
[Index("AppCd", "ValidEntryInd", Name = "nc5_agt_rx")]
public partial class AgtRx
{
    [Key]
    [Column("pt_id")]
    [StringLength(20)]
    ...
    [Column("benefit_payor_name")]
    [StringLength(512)]
    public string? BenefitPayorName { get; set; }

    [Column("benefit_payor_id")]
    [StringLength(50)]
    public string? BenefitPayorId { get; set; }

    [Column("benefit_payor_member_id")]
    [StringLength(80)]
    public string? BenefitPayorMemberId { get; set; }

    [Column("benefit_copay_abr")]
    [StringLength(100)]
    public string? BenefitCopayAbr { get; set; }

    [Column("benefit_coverage")]
    [StringLength(1024)]
    ...
    [InverseProperty("AgtRx")]
    public virtual ICollection<AgtRxImmun> AgtRxImmun { get; set; } = new List<AgtRxImmun>();
    ...
    [InverseProperty("AgtRx")]
    public virtual ICollection<TherapyItemAdmnAgtLevel> TherapyItemAdmnAgtLevel { get; set; } = new List<TherapyItemAdmnAgtLevel>();
}
