...
[PrimaryKey("InstId", "HxCompCatId")]
[Table("inst_hx_comp_cat")]
public partial class InstHxCompCat
{
    [Key]
    [Column("inst_id")]
    [StringLength(30)]
    ...
    [Column("hx_comp_cat_desc")]
    [StringLength(40)]
    public string? HxCompCatDesc { get; set; }
