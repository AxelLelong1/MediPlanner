...
[PrimaryKey("PtId", "PtVisitId", "VisitNoteId")]
[Table("visit_note")]
[Index("SupervisorStkhId", Name = "nc11_visit_note")]
[Index("AuthorStkhId", Name = "nc12_visit_note")]
[Index("CreatorStkhId", Name = "nc13_visit_note")]
[Index("SignedStkhId", Name = "nc14_visit_note")]
[Index("TransLogMtstamp", Name = "nc15_visit_note")]
[Index("TransLogTstamp", Name = "nc16_visit_note")]
[Index("OverrideInstId", "OverrideUserid", Name = "nc1_visit_note")]
[Index("CertStkhId", "NoteTstamp", Name = "nc2_visit_note")]
[Index("NoteTstamp", Name = "nc3_visit_note")]
[Index("CertStkhId", "ApprFlag", "NoteTstamp", Name = "nc5_visit_note")]
[Index("ApprFlag", "TransLogMtstamp", "ValidEntryInd", Name = "nc6_visit_note")]
[Index("DocFileLoc", Name = "nc7_visit_note")]
[Index("ImgDcmntId", Name = "nc9_visit_note")]
public partial class VisitNote
{
    ...
    [Column("doc_preview_loc")]
    [StringLength(255)]
    public string? DocPreviewLoc { get; set; }

    [ForeignKey("PtId, BillAcctId")]
    [InverseProperty("VisitNote")]
    public virtual BillAcct? BillAcct { get; set; }

    [ForeignKey("NoteLevel")]
    [InverseProperty("VisitNote")]
    public virtual NoteLevel? NoteLevelNavigation { get; set; }

    [ForeignKey("NoteTyp")]
    [InverseProperty("VisitNote")]
    public virtual NoteTyp? NoteTypNavigation { get; set; }

    [ForeignKey("PtId, PtEvalId")]
    [InverseProperty("VisitNote")]
    public virtual PtTpEval? PtTpEval { get; set; }
