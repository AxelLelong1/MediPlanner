...
[Table("intf_pt_key_map_varis")]
public partial class IntfPtKeyMapVaris
{
    [Key]
    ...
    [StringLength(1)]
    public string AllowUpdateInd { get; set; } = null!;
    ...
    [StringLength(1)]
    public string DisplayKey1Ind { get; set; } = null!;

    [Column("display_key_2_ind")]
    [StringLength(1)]
    public string DisplayKey2Ind { get; set; } = null!;
    ...
    [StringLength(30)]
    public string? PtKeyCdInstId { get; set; }
}
